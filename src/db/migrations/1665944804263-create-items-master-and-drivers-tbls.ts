...
export class createItemsMasterAndDriversTbls1665944804263
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "itemMaster" ("id" int NOT NULL IDENTITY(1,1), "description" varchar(100) NOT NULL, "itemType" smallint NOT NULL, "createdAt" datetime NOT NULL CONSTRAINT "DF_65848bddeb302a9b9038f32d479" DEFAULT getdate(), "updatedAt" datetime NOT NULL CONSTRAINT "DF_a2c7f5a3c97b9b61c1ccdfba814" DEFAULT getdate(), CONSTRAINT "UQ_a00b54ed8ecabec62472c794bd7" UNIQUE ("description"), CONSTRAINT "PK_5aff43f41bfa220ce4bf516d369" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
